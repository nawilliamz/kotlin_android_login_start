...
class FirebaseUserLiveData : LiveData<FirebaseUser?>() {
    ...
    private val authStateListener = FirebaseAuth.AuthStateListener { firebaseAuth ->
        ...
        //This user will get a callback every time the current user has changed; whether a new user has
        //logged in or a user has logged out
        val value = firebaseAuth.currentUser
