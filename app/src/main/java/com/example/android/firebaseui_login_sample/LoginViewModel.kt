...
class LoginViewModel : ViewModel() {
    ...
    //These states should be updated whenver our FirebaseUser LiveData emits new updates.
    ...
    //This value is a LiveData whose value is an enum value of AuthenticationState
    //Remember, FirebaseUserLiveData() is an instance of our class of same name.
    //Here you can also add different types of authentication state such as "in progress" or "signing up"
